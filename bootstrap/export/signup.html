...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-10">
                ...
                <div class="card-body p-0">
                    <div class="row no-gutters">
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="mb-5">
                                    <h3 class="h4 font-weight-bold text-theme">S'enregistrer</h3>
                                </div>
                                <h6 class="h5 mb-0">Créer un compte</h6>
                                <p class="text-muted mt-2 mb-5">Entrez vos informations d'identification.</p>
                                <form>
                                    ...
                                    <div class="form-group mb-5">
                                        ...
                                        <input type="password" class="form-control" id="exampleInputPassword1" /> <label for="exampleInputPassword1">Confirmer votre mot de passe</label>
                                        <input type="password" class="form-control" id="exampleInputPassword1" />
                                    </div>
                                    
                                    <button type="submit" class="btn btn-theme">S'enregistrer</button>
                                </form>
                            </div>
                        </div>
                        <div class="col-lg-6 d-none d-lg-inline-block">
                            <div class="account-block rounded-right">
                                ...
                                <div class="account-testimonial">
                                    <h4 class="text-white mb-4">Adémad</h4>
                                    <p class="lead text-white">Le BDE (Bureau des étudiants) de l'UFR Science et technique de Rouen</p>
                                    <p>Association des étudiants du madrillet</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- end card -->
            <p class="text-muted text-center mt-3 mb-0">Vous avez déja un compte ? <a href="login.html" class="text-primary ml-1">Se connecter</a></p>
            <!-- end row -->
        </div>
        <!-- end col -->
    </div>
