...
<body>
    ...
    </div><span class="text-end" data-reflow-type="view-cart" data-reflow-summary-type="dropdown"><span>Cart</span></span>
    <div class="row .payment-dialog-row" style="margin-top: 10vh;margin-bottom: 10vh;">
        <div class="col-12 col-md-4 offset-md-4">
            <div class="card credit-card-box">
                <div class="card-header">
                    <h3><span class="panel-title-text">Paiement</span><img class="img-fluid panel-title-image" src="../assets/img/accepted_cards.png"></h3>
                </div>
                <div class="card-body">
                    <form id="payment-form">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-3"><label class="form-label" for="cardNumber">Numéro de carte</label>
                                    <div class="input-group"><input class="form-control" type="tel" id="cardNumber" required="" placeholder="Numéro de carte"><span class="input-group-text"><i class="fa fa-credit-card"></i></span></div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-7">
                                <div class="form-group mb-3"><label class="form-label" for="cardExpiry">date d'expiration</label><input class="form-control" type="tel" id="cardExpiry" required="" placeholder="MM / AA"></div>
                            </div>
                            <div class="col-5 pull-right">
                                <div class="form-group mb-3"><label class="form-label" for="cardCVC">code CVC</label><input class="form-control" type="tel" id="cardCVC" required="" placeholder="CVC"></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12"><button class="btn btn-success btn-lg d-block w-100" type="submit">Payer</button></div>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script src="../assets/js/navbar/nav-boutique.js"></script>
</body>
