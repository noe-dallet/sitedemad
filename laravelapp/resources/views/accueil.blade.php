...
<body>
    ...
    <div class="container" id="next_event">
        ...
        </div><a class="btn btn-primary" role="button" href="calendrier.html">Calendrier des&nbsp;Événements</a>
    </div>
    <div class="container" id="suggestions" style="margin-bottom: 10vh;">
        ...
        </div><a class="btn btn-primary" role="button" href="propositions.html">Une suggestion ?</a>
    </div>
