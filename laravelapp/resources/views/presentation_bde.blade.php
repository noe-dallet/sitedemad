...
<head>
    ...
    <link rel="stylesheet" href="assets/css/presentation_bde.min.css">
</head>
...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
    ...
    <div class="text-center">
        ...
        <div class="container" id="adhesion">
            <h1>Adhésion</h1>
            <p>Les flibustiers étaient des marins qui avaient ou non des «&nbsp;lettres de marque&nbsp;». Ils se livraient à des expéditions à but lucratif et leur activité est généralement tolérée par les pouvoirs. Ils sont surtout présents dans le bassin caribéen aux XVIe et XVIIe&nbsp;siècles, qui devient alors un haut-lieu de la flibuste.</p><a class="btn btn-primary" role="button" href="adherer">Adhérer</a>
        </div>
    ...
    <script src="assets/js/nav-presentation_bde.min.js"></script>
</body>
