...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-10">
                ...
                <div class="card-body p-0">
                    <div class="row no-gutters">
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="mb-5">
                                    <h3 class="h4 font-weight-bold text-theme">Se connecter</h3>
                                </div>

                                <h6 class="h5 mb-0">Content de vous revoir !</h6>
                                <p class="text-muted mt-2 mb-5">Entrez votre adresse mail et votre mot de passe pour vous connecter</p>
                        ...
                        <div class="col-lg-6 d-none d-lg-inline-block">
                            <div class="account-block rounded-right">
                                ...
                                <div class="account-testimonial">
                                    ...
                                    Le BDE (bureau des étudiants) de l'UFR sciences et technique de Rouen</p>
            ...
            <p class="text-muted text-center mt-3 mb-0">Vous n'avez pas de compte ? <a href="../enregistrement" class="text-primary ml-1">S'enregistrer</a></p>
