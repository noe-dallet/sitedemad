...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/boutique-merci.css">
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col" style="text-align: center;margin-top: 10vh;margin-bottom: 10vh;"><span><i class="material-icons">check_circle</i>Paiement réussi !</span></div>
        </div>
        <div class="row">
            <div class="col text-center">
                <h3>Merci de nous avoir fait confiance !</h3>
            </div>
        </div>
        <div class="row">
            <div class="col text-center"><button class="btn btn-primary" type="button" style="margin-top: 10vh;margin-bottom: 10vh;">Retourner à l'acceuil</button></div>
        </div>
    </div>
